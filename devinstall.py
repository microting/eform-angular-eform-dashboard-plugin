...
# Define paths
src_base = os.path.join("Documents", "workspace", "microting", "eform-angular-eform-dashboard-plugin")
dst_base = os.path.join("Documents", "workspace", "microting", "eform-angular-frontend")

# Remove and copy directories
paths = [
    (os.path.join("eform-client", "src", "app", "plugins", "modules", "eform-dashboard-pn"),
     os.path.join("eform-client", "src", "app", "plugins", "modules", "eform-dashboard-pn")),
    (os.path.join("eFormAPI", "Plugins", "eFormDashboard.Pn"),
     os.path.join("eFormAPI", "Plugins", "eFormDashboard.Pn")),
]
...
test_files_to_remove = [
    os.path.join("eform-client", "e2e", "Tests", "eform-dashboard-settings"),
    os.path.join("eform-client", "e2e", "Tests", "eform-dashboard-general"),
    os.path.join("eform-client", "e2e", "Page objects", "eFormDashboard"),
