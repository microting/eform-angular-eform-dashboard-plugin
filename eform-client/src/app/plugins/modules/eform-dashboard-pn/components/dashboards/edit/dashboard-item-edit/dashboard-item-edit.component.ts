...
import {eformDashboardPnDashboardDictionariesService, eformDashboardPnDashboardItemsService} from '../../../../services';
...
export class DashboardItemEditComponent implements OnInit, OnDestroy, OnChanges {
  ...
  constructor(private dictionariesService: eformDashboardPnDashboardDictionariesService,
              private translateService: TranslateService, private collapseService: eformDashboardPnCollapseService,
              private dashboardItemService: eformDashboardPnDashboardItemsService) {
  }
